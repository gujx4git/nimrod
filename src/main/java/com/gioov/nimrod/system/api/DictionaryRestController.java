...
public class DictionaryRestController {
    ...
    public ResponseEntity<DictionaryEntity> addOne(@RequestParam String key, @RequestParam String keyName, @RequestParam String valueName, @RequestParam String valueSlug, @RequestParam String value, @RequestParam Long dictionaryCategoryId, @RequestParam Integer editable, @RequestParam Long sort, @RequestParam String remark) {
        ...
        dictionaryEntity.setEditable(editable);
    ...
    public ResponseEntity<DictionaryEntity> saveOne(@RequestParam Long id, @RequestParam String key, @RequestParam String keyName, @RequestParam String valueName, @RequestParam String valueSlug, @RequestParam String value, @RequestParam Integer editable, @RequestParam Long sort, @RequestParam String remark) {
        DictionaryEntity dictionaryEntity = new DictionaryEntity();
    ...
    public ResponseEntity<List<DictionaryEntity>> listAllByKey(@PathVariable String key) {
        return new ResponseEntity<>(dictionaryService.listAllByKey(key), HttpStatus.OK);
    }

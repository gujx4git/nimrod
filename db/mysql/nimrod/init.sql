...
CREATE TABLE `department` (
  ...
  `gmt_created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='部门表';
...
CREATE TABLE `dictionary` (
  ...
  `gmt_created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='数据字典表';

-- ----------------------------
-- Records of dictionary
-- ----------------------------
BEGIN;
INSERT INTO `dictionary` VALUES (1, 'WEB', '网站字段', '网站名', 'NAME', 'Nimrod', 1, 3, 0, '', '2018-12-03 00:33:43', '2018-07-08 15:29:33');
INSERT INTO `dictionary` VALUES (2, 'WEB', '网站字段', '页脚版权', 'FOOTER', 'Copyright &copy; 2018 Nimrod.All rights reserved.', 1, 3, 0, '', '2018-12-03 00:28:58', '2018-07-08 15:29:33');
...
INSERT INTO `dictionary` VALUES (6, 'MAIL', '电子邮箱发信配置', '用户名', 'USERNAME', 'no-reply@example.com', 1, 4, 0, '', '2018-12-18 02:00:11', '2018-07-08 15:29:33');
INSERT INTO `dictionary` VALUES (7, 'MAIL', '电子邮箱发信配置', '密码', 'PASSWORD', '123456', 1, 4, 0, '', '2018-12-18 02:00:30', '2018-07-08 15:29:33');
INSERT INTO `dictionary` VALUES (8, 'MAIL', '电子邮箱发信配置', '显示邮箱', 'FROM', 'no-reply@example.com', 1, 4, 0, '', '2018-12-18 02:00:15', '2018-07-08 15:29:33');
...
INSERT INTO `dictionary` VALUES (24, 'ATTACHMENT', '附件配置', '上传路径', 'UPLOAD_PATH', '/upload', 1, 11, 0, '', '2018-12-17 13:04:38', '2018-11-19 07:41:07');
INSERT INTO `dictionary` VALUES (25, 'OPERATION_TYPE', '操作类型', '页面访问', 'PAGE', '0', 1, 12, 0, '', '2018-12-17 12:14:08', '2018-12-17 12:13:32');
INSERT INTO `dictionary` VALUES (26, 'OPERATION_TYPE', '操作类型', 'API 调用', 'API', '1', 1, 12, 0, '', '2018-12-17 12:37:32', '2018-12-17 12:14:42');
INSERT INTO `dictionary` VALUES (27, 'ATTACHMENT', '附件配置', '附件类型', 'TYPE', '.jpg,.png,.zip', 1, 11, 0, '允许上传的文件类型', '2018-12-17 13:10:45', '2018-12-17 13:08:13');
INSERT INTO `dictionary` VALUES (28, 'ATTACHMENT', '附件配置', '最大文件上传大小', 'MAX_FILE_SIZE', '1KB', 1, 11, 0, '允许上传的最大文件大小', '2018-12-21 04:54:26', '2018-12-17 13:10:23');
INSERT INTO `dictionary` VALUES (29, 'SYSTEM', '系统配置', '语言', 'LANGUAGE', 'zh', 1, 13, 0, '', '2018-12-19 08:41:34', '2018-12-19 08:25:09');
INSERT INTO `dictionary` VALUES (30, 'SYSTEM', '系统配置', '国家/区域', 'COUNTY', 'CN', 1, 13, 0, '', '2018-12-19 08:41:42', '2018-12-19 08:27:08');
INSERT INTO `dictionary` VALUES (31, 'SYSTEM', '系统配置', '时区标识符', 'TIME_ZONE_ID', 'GMT+8', 1, 13, 0, '', '2018-12-19 08:41:49', '2018-12-19 08:30:44');
INSERT INTO `dictionary` VALUES (32, 'SYSTEM', '系统配置', '日期格式', 'DATE_FORMAT_PATTERN', 'yyyy-MM-dd HH:mm:ss', 1, 13, 0, '', '2018-12-20 02:40:07', '2018-12-19 08:32:46');
INSERT INTO `dictionary` VALUES (33, 'ATTACHMENT', '附件配置', '最大请求上传大小', 'MAX_REQUEST_SIZE', '10KB', 1, 11, 0, '', '2018-12-21 04:54:33', '2018-12-21 01:05:54');
COMMIT;
...
CREATE TABLE `dictionary_category` (
  ...
  `gmt_created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='数据字典分类表';
...
CREATE TABLE `view_menu` (
  ...
  `gmt_created` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='视图菜单表';
